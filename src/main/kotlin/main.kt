...
fun main(args: Array<String>) {
    if (args.isEmpty()) {
        TODO("Error: Please specify the first file")
    }
    if (args.size == 1) {
        TODO("Error: Please specify the second file")
    }

    val fileName1 = args[0]
    val fileName2 = args[1]
    val input1: Array<String> = readFile(fileName1)
    val input2: Array<String> = readFile(fileName2)
